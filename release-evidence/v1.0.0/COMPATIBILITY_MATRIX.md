...
This matrix defines certified compatibility outcomes for OpenClaw runtime versions.

Status values:
- `CERTIFIED_ENFORCED`: Trusted Mode Check passed; enforcement claims allowed.
- `LOCKDOWN_ONLY`: runtime usable with conservative fallback posture; do not claim full provable enforcement.
- `UNSUPPORTED`: not certified for this plugin release.
